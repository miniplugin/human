...
Insert into XE.TBL_BOARD (BNO,TITLE,WRITER,REGDATE,UPDATE_DATE,VIEW_COUNT,REPLY_COUNT,BOD_TYPE) values (99,'게시물제목','관리자',to_timestamp('20/07/30 09:14:31.000000000','RR/MM/DD HH24:MI:SSXFF'),to_date('20/07/31','RR/MM/DD'),7,0,'gallery');
REM INSERTING into XE.TBL_BOARD_TYPE
SET DEFINE OFF;
Insert into XE.TBL_BOARD_TYPE (BOD_TYPE,BOD_SUN,BOD_NAME) values ('notice',1,'알림판');
Insert into XE.TBL_BOARD_TYPE (BOD_TYPE,BOD_SUN,BOD_NAME) values ('gallery',2,'갤러리');
REM INSERTING into XE.TBL_MEMBER
SET DEFINE OFF;
Insert into XE.TBL_MEMBER (USER_ID,USER_PW,USER_NAME,EMAIL,POINT,ENABLED,LEVELS,REG_DATE,UPDATE_DATE) values ('user01','$2a$10$62oNpBjuKajlzZQdv6QbZOUIuJfa.gizJl9eLsgqIkYnhhLx31r2W','사용자1','aaa@aaa.com',0,0,'ROLE_USER',to_date('20/01/01','RR/MM/DD'),to_date('20/01/10','RR/MM/DD'));
Insert into XE.TBL_MEMBER (USER_ID,USER_PW,USER_NAME,EMAIL,POINT,ENABLED,LEVELS,REG_DATE,UPDATE_DATE) values ('user02','$2a$10$62oNpBjuKajlzZQdv6QbZOUIuJfa.gizJl9eLsgqIkYnhhLx31r2W','사용자2','aaa@aaa.com',0,0,'ROLE_USER',to_date('20/01/01','RR/MM/DD'),to_date('20/01/18','RR/MM/DD'));
Insert into XE.TBL_MEMBER (USER_ID,USER_PW,USER_NAME,EMAIL,POINT,ENABLED,LEVELS,REG_DATE,UPDATE_DATE) values ('admin','$2a$10$62oNpBjuKajlzZQdv6QbZOUIuJfa.gizJl9eLsgqIkYnhhLx31r2W','관리자','aaa@aaa.com',0,0,'ROLE_ADMIN',to_date('20/07/29','RR/MM/DD'),to_date('20/08/18','RR/MM/DD'));
