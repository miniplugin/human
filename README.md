...
### [v1.0.0](https://github.com/miniplugin/human/tree/v1.0.0) 응용SW기초기술활용 (2001020232_19v4)

- 11월09일~11월17일(50시간) : 혼합형평가
- 평가항목(수준3) : 평가자체크리스트 + 서술형(11월17일,2교시)

### [v2.0.0](https://github.com/miniplugin/human/tree/v2.0.0) 화면설계 (2001020224_19v5)

- 11월17일~11월25일(48시간) : 
- 평가항목 (수준5): 포트폴리오(11월25일,2교시)

### [v3.0.0](https://github.com/miniplugin/human/tree/v3.0.0) 화면구현 (2001020225_19v5)

- 11월25일~12월03일(48시간) : 
- 평가항목(수준3) : 포트폴리오(12월03일,2교시)

### [v4.0.0](https://github.com/miniplugin/human/tree/v4.0.0) 프로그래밍언어활용 (2001020231_19v4)

- 12월03일~12월17일(80시간) : 
- 평가항목(수준3) : 문제해결시나리오(12월17일,2교시)

### [v5.0.0](https://github.com/miniplugin/human/tree/v5.0.0) 통합구현 (2001020206_19v5)

- 12월17일~12월24일(40시간) : 
- 평가항목(수준5) : 문제해결시나리오(12월24일,2교시)

### [v6.0.0](https://github.com/miniplugin/human/tree/v6.0.0) UI구현 (2001020708_19v3)

- 12월24일~02월03일(216시간) : 
- 평가항목(수준3) : 포트폴리오(02월03일,2교시)

### [v7.0.0](https://github.com/miniplugin/human/tree/v7.0.0) SQL활용 (2001020413_19v4)

- 02월03일~02월08일(30시간) :  혼합형
- 평가항목(수준3) : 평가자체크리스트 + 서술형(02월08일,8교시)

### [v8.0.0](https://github.com/miniplugin/human/tree/v8.0.0) 서버프로그램 구현 (2001020211_19v5)

- 02월09일~02월22일(60시간) : 
- 평가항목(수준5) : 포트폴리오(02월22일,4교시)

### [v9.0.0](https://github.com/miniplugin/human/tree/v9.0.0) 인터페이스 구현 (2001020212_19v5)

- 02월22일~03월02일(40시간) : 
- 평가항목(수준5) : 문제해결시나리오(03월02일,4교시)

### [v10.0.0](https://github.com/miniplugin/human/tree/v10.0.0) 요구사항 확인 (2001020201_19v4)

- 03월02일~03월09일(40시간) : 
- 평가항목(수준5) : 평가자체크리스트(03월09일,4교시)

### [v11.0.0](https://github.com/miniplugin/human/tree/v11.0.0) 애플리케이션 설계 (2001020221_19v5)

- 03월09일~03월16일(40시간) : 혼합형
- 평가항목(수준6) : 평가자체크리스트 + 서술형(03월16일,4교시)

### [v12.0.0](https://github.com/miniplugin/human/tree/v12.0.0) 애플리케이션 테스트 수행 (2001020227_19v5)

- 03월16일~03월23일(40시간) : 
- 평가항목(수준3) : 문제해결시나리오(03월23일,4교시)

### [v13.0.0](https://github.com/miniplugin/human/tree/v13.0.0) 펌웨어 구현 (2001020314_19v6)

- 03월23일~03월30일(40시간) : 
- 평가항목(수준5) : 문제해결시나리오(03월30일,4교시)

### [v14.0.0](https://github.com/miniplugin/human/tree/v14.0.0) 디바이스 드라이버 구현 (2001020320_19v6)

- 03월30일~04월06일(40시간) : 
- 평가항목(수준6) : 문제해결시나리오(04월06일,4교시)

### [v15.0.0](https://github.com/miniplugin/human/tree/v15.0.0) 임베디드 애플리케이션 구현 (2001020324_19v6)

- 04월06일~04월13일(40시간) : 
- 평가항목(수준5) : 포트폴리오(04월13일,4교시)

### [v16.0.0](https://github.com/miniplugin/human/tree/v16.0.0) 네트워크 프로그래밍 구현 (2001020508_19v3)

- 04월13일~04월21일(48시간) : 
- 평가항목(수준3) : 포트폴리오(04월21일,4교시)
